...
class HTMLCreator extends FeedCreator {
	...
	function createFeed() {
		...
		$feedArray[] = '<html><head><title>'.htmlspecialchars($this->title).'</title></head><body>';
		...
		if ($this->title) {
			$feedArray[] = "<div class='".$this->stylePrefix."title'><a href='".$this->link."' title='".FeedCreator::iTrunc(htmlspecialchars($this->title),100)."'".$targetInsert." class='".$this->stylePrefix."title'>".
